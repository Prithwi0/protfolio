                ...
                <div className="hero__text">
                    ...
                    <div className="hero__stats">
                        ...
                        <div className="hero__stat">
                            ...
                            <span className="hero__stat-label">Certs</span>
                        </div>
                    </div>
                    ...
                    <div className="hero__social">
                        ...
                        <a href="mailto:suklar999@gmail.com" className="hero__social-link" aria-label="Email">
                            <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/></svg>
                        </a>
                    </div>
                </div>
